...
const Footer = () => {
  return (
    <footer className="bg-gray-50 dark:bg-[#0b0e14] text-gray-600 dark:text-gray-400 py-12 border-t border-gray-200 dark:border-white/5 mt-20 transition-colors duration-500">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          
          {/* ستون اول: درباره ما */}
          <div className="space-y-4">
            <h4 className="text-gray-900 dark:text-white font-bold text-lg">Steam Clone</h4>
          ...
          <div className="space-y-4">
            <h4 className="text-gray-900 dark:text-white font-bold text-lg">دسترسی سریع</h4>
          ...
          {/* ستون سوم: پشتیبانی */}
          <div className="space-y-4">
            <h4 className="text-gray-900 dark:text-white font-bold text-lg">خدمات مشتریان</h4>
            <ul className="space-y-2 text-sm">
          ...
          <div className="space-y-4">
            <h4 className="text-gray-900 dark:text-white font-bold text-lg">همراه ما باشید</h4>
            <div className="flex gap-4 text-2xl">
              <FaGithub className="hover:text-gray-900 dark:hover:text-white cursor-pointer transition" />
            ...
            <div className="pt-4">
              ...
              <div className="flex mt-2">
                <input 
                  ...
                  className="bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 text-gray-900 dark:text-white rounded-r-md px-3 py-2 text-sm w-full outline-none focus:border-blue-500"
                />
        ...
        <div className="border-t border-gray-200 dark:border-white/5 mt-12 pt-8 text-center text-xs tracking-widest uppercase">
